...
const Introduction = () => {
  return (
    <>
      {/* intro section */}
      <section className="md:flex w-full py-4 md:py-20">
        <div className="flex-1 basis-3/4">
          <div className="flex-1 text-left">
            ...
            <h1 className="text-5xl font-bold">I'm Christian</h1>
            <h2
        ...
        <div className="flex-2 md:flex basis-1/4 justify-center hidden h-1/2">
          <Image
            alt="Animation"
            src={profileImage}
